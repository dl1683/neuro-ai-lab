...
measured post-load generator-snapshot revalidation. CPU-only validation passes
11/11 stopping property cases, 13/13 lifecycle/integrity checks, and 4/4
independent arithmetic-gate checks; the lifecycle

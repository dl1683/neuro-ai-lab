...
The 30M mechanics pilot remains formally independent of both task-band gates and still requires its own independent pre-training code review. Full-program launch remains blocked until the mechanics pilot has an admissible outcome, a new untouched cross-family transfer set is frozen by pre-data amendment, and launch review is complete.

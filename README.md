...
| Line | Thesis | State |
|---|---|---|
| 04 Circuit-viability pruning | Useful sparse networks are viable circuits, not collections of important synapses. Severe pruning fails when it destroys circuit viability. | FROZEN / AUDITED (claim audit `230/230`) |

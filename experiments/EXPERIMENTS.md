...
**INTERPRETATION — substrate-starvation post-mortem (non-adjudicating; source: 2026-08-10 steering post-mortem):** The steering diagnosis is that the from-scratch substrate likely stopped before an algorithm-learning phase transition, not that the registered latch mechanism was tested and failed. Each seed received 500,000 of 1,878,154 controller-training tokens, or 0.266219 corpus passes; this produced 551 optimizer updates for seed 42 and 552 for seed 31415. Final recurrent validation CE was 1.39256 and 1.39244 respectively, close to four-way chance CE `ln(4) = 1.38629`. Those measurements motivate the separate competence/learnability diagnostic, but this paragraph is interpretation only: it does not alter the registered E2 verdict, denominator precedence, official-test boundary, or blocked 0.5B launch.

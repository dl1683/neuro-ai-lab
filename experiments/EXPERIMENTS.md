...
### E3 Interface-Supervision Diagnostic (REVIEW FINDINGS REPAIRED / HASH-BOUND / NOT RUN)
...
- **Projection and launch boundary:** Each cell is capped at 900 GPU-wall seconds and the single complete invocation at 5,400 seconds including loading, caches, evaluation, and publication. The GPU-free projection, anchored to the immutable E3 preflight measurement and full audited workload, is I0 150s, I1 140s, I2 850s, S0 80s, S1 260s, and S2 700s, totaling 2,180/5,400s. Launch remains blocked on independent re-review and explicit clean-launch attestation; no clean-review token is claimed.

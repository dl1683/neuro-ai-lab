...
def checks():
    ...
    out.append(close(tinyvit_boundary["seed_count"], 11, "TinyViT strong boundary seed count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v3_mean_delta_vs_magnitude"], 0.031027272727272726, "TinyViT strong boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_gap_to_best"], 0.010454545454545456, "TinyViT strong boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v4_mean_delta_vs_magnitude"], 0.03147272727272727, "TinyViT V4 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_gap_to_best"], 0.01000909090909091, "TinyViT V4 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v5_mean_delta_vs_magnitude"], 0.04148181818181818, "TinyViT V5 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))

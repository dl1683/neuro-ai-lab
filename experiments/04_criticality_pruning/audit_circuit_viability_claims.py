...
def checks():
    ...
    tinyvit_v5_seed310 = load("cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed310.json")
    out.append(close(tinyvit_v5_seed310["dense_accuracy_mean"], 0.7209, "TinyViT V5 seed310 dense accuracy", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed310.json"))
    out.append(close(tinyvit_v5_seed310["summary"]["feature_route_margin_policy"]["after_mean"], 0.1516, "TinyViT V5 seed310 policy after", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed310.json"))
    out.append(close(tinyvit_v5_seed310["summary"]["feature_route_margin_policy"]["after_delta_mean"], 0.09300000000000001, "TinyViT V5 seed310 policy delta", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed310.json"))
    out.append(close(tinyvit_v5_seed310["decisions"][0]["selected_method"], "global_synflow", "TinyViT V5 seed310 selector decision", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed310.json"))
    out.append(close(tinyvit_v5_seed310["decisions"][0]["reason"], "synflow_masked_recovery_prior", "TinyViT V5 seed310 selector reason", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed310.json"))
    tinyvit_v5_seed311 = load("cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed311.json")
    out.append(close(tinyvit_v5_seed311["dense_accuracy_mean"], 0.7291, "TinyViT V5 seed311 dense accuracy", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed311.json"))
    out.append(close(tinyvit_v5_seed311["summary"]["feature_route_margin_policy"]["after_mean"], 0.1591, "TinyViT V5 seed311 policy after", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed311.json"))
    out.append(close(tinyvit_v5_seed311["summary"]["feature_route_margin_policy"]["after_delta_mean"], 0.06119999999999999, "TinyViT V5 seed311 policy delta", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed311.json"))
    out.append(close(tinyvit_v5_seed311["decisions"][0]["selected_method"], "global_synflow", "TinyViT V5 seed311 selector decision", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed311.json"))
    out.append(close(tinyvit_v5_seed311["decisions"][0]["reason"], "feature_argmax", "TinyViT V5 seed311 selector reason", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed311.json"))
    tinyvit_v5_seed312 = load("cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed312.json")
    out.append(close(tinyvit_v5_seed312["dense_accuracy_mean"], 0.7297, "TinyViT V5 seed312 dense accuracy", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed312.json"))
    out.append(close(tinyvit_v5_seed312["summary"]["feature_route_margin_policy"]["after_mean"], 0.1187, "TinyViT V5 seed312 policy after", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed312.json"))
    out.append(close(tinyvit_v5_seed312["summary"]["feature_route_margin_policy"]["after_delta_mean"], -0.00020000000000000573, "TinyViT V5 seed312 policy delta", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed312.json"))
    out.append(close(tinyvit_v5_seed312["summary"]["minimal_liveness_repair"]["after_mean"], 0.121, "TinyViT V5 seed312 minimal liveness after", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed312.json"))
    out.append(close(tinyvit_v5_seed312["decisions"][0]["selected_method"], "attn_mlp_readout_repair", "TinyViT V5 seed312 selector decision", "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong_seed312.json"))
    tinyvit_v6_seed313 = load("cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed313.json")
    out.append(close(tinyvit_v6_seed313["dense_accuracy_mean"], 0.7229, "TinyViT V6 seed313 dense accuracy", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed313.json"))
    out.append(close(tinyvit_v6_seed313["summary"]["feature_route_margin_policy"]["after_mean"], 0.1644, "TinyViT V6 seed313 policy after", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed313.json"))
    out.append(close(tinyvit_v6_seed313["summary"]["feature_route_margin_policy"]["after_delta_mean"], 0.0, "TinyViT V6 seed313 policy delta", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed313.json"))
    out.append(close(tinyvit_v6_seed313["decisions"][0]["selected_method"], "magnitude", "TinyViT V6 seed313 selector decision", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed313.json"))
    tinyvit_v6_seed315 = load("cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed315.json")
    out.append(close(tinyvit_v6_seed315["dense_accuracy_mean"], 0.7244, "TinyViT V6 seed315 dense accuracy", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed315.json"))
    out.append(close(tinyvit_v6_seed315["summary"]["feature_route_margin_policy"]["after_mean"], 0.1234, "TinyViT V6 seed315 policy after", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed315.json"))
    out.append(close(tinyvit_v6_seed315["summary"]["feature_route_margin_policy"]["after_delta_mean"], -0.000800000000000009, "TinyViT V6 seed315 policy delta", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed315.json"))
    out.append(close(tinyvit_v6_seed315["decisions"][0]["selected_method"], "all_route_liveness_floor", "TinyViT V6 seed315 selector decision", "cifar10_tiny_vit_feature_route_margin_selector_v6_90pct_strong_seed315.json"))
    tinyvit_v6_scan = load("find_tiny_v6_live_repair_tiebreak_seed.json")
    out.append(close(tinyvit_v6_scan["found_live_repair_tiebreak"], False, "TinyViT V6 tie-break scanner found branch", "find_tiny_v6_live_repair_tiebreak_seed.json"))
    out.append(close(tinyvit_v6_scan["scanned_count"], 6, "TinyViT V6 tie-break scanner count", "find_tiny_v6_live_repair_tiebreak_seed.json"))
    tinyvit_v7_seed320 = load("cifar10_tiny_vit_feature_route_margin_selector_v7_90pct_strong_seed320.json")
    out.append(close(tinyvit_v7_seed320["dense_accuracy_mean"], 0.7228, "TinyViT V7 seed320 dense accuracy", "cifar10_tiny_vit_feature_route_margin_selector_v7_90pct_strong_seed320.json"))
    out.append(close(tinyvit_v7_seed320["summary"]["feature_route_margin_policy"]["after_mean"], 0.1193, "TinyViT V7 seed320 policy after", "cifar10_tiny_vit_feature_route_margin_selector_v7_90pct_strong_seed320.json"))
    out.append(close(tinyvit_v7_seed320["summary"]["feature_route_margin_policy"]["after_delta_mean"], 0.029200000000000004, "TinyViT V7 seed320 policy delta", "cifar10_tiny_vit_feature_route_margin_selector_v7_90pct_strong_seed320.json"))
    out.append(close(tinyvit_v7_seed320["decisions"][0]["selected_method"], "global_synflow", "TinyViT V7 seed320 selector decision", "cifar10_tiny_vit_feature_route_margin_selector_v7_90pct_strong_seed320.json"))
    tinyvit_v7_scan = load("find_tiny_v7_magnitude_live_guardrail_seed.json")
    out.append(close(tinyvit_v7_scan["found_magnitude_live_guardrail"], False, "TinyViT V7 guardrail scanner found branch", "find_tiny_v7_magnitude_live_guardrail_seed.json"))
    out.append(close(tinyvit_v7_scan["scanned_count"], 6, "TinyViT V7 guardrail scanner count", "find_tiny_v7_magnitude_live_guardrail_seed.json"))
    tinyvit_boundary = load("tiny_vit_strong_selector_boundary_synthesis.json")
    out.append(close(tinyvit_boundary["seed_count"], 15, "TinyViT strong boundary seed count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_positive_vs_magnitude"], 9, "TinyViT strong boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_matches_best"], 9, "TinyViT strong boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_delta_vs_magnitude"], 0.024633333333333333, "TinyViT strong boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_gap_to_best"], 0.007873333333333335, "TinyViT strong boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_positive_vs_magnitude"], 9, "TinyViT V4 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_matches_best"], 11, "TinyViT V4 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_delta_vs_magnitude"], 0.02496, "TinyViT V4 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_gap_to_best"], 0.007546666666666668, "TinyViT V4 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_positive_vs_magnitude"], 10, "TinyViT V5 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_matches_best"], 13, "TinyViT V5 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_mean_delta_vs_magnitude"], 0.0323, "TinyViT V5 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_mean_gap_to_best"], 0.00020666666666666704, "TinyViT V5 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_positive_vs_magnitude"], 11, "TinyViT V6 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_matches_best"], 14, "TinyViT V6 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_mean_delta_vs_magnitude"], 0.032453333333333334, "TinyViT V6 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_mean_gap_to_best"], 5.3333333333333936e-05, "TinyViT V6 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v7_positive_vs_magnitude"], 11, "TinyViT V7 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v7_matches_best"], 15, "TinyViT V7 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v7_mean_delta_vs_magnitude"], 0.03250666666666667, "TinyViT V7 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v7_mean_gap_to_best"], 0.0, "TinyViT V7 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))

...
def checks():
    ...
    out.append(close(tinyvit_boundary["seed_count"], 12, "TinyViT strong boundary seed count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v3_matches_best"], 7, "TinyViT strong boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_delta_vs_magnitude"], 0.028424999999999995, "TinyViT strong boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_gap_to_best"], 0.009775, "TinyViT strong boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v4_matches_best"], 9, "TinyViT V4 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_delta_vs_magnitude"], 0.028833333333333332, "TinyViT V4 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_gap_to_best"], 0.009366666666666667, "TinyViT V4 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v5_matches_best"], 11, "TinyViT V5 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_mean_delta_vs_magnitude"], 0.03800833333333333, "TinyViT V5 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_mean_gap_to_best"], 0.00019166666666666637, "TinyViT V5 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))

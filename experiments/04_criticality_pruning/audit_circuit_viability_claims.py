...
def checks():
    ...
    out.append(close(tinyvit_boundary["seed_count"], 8, "TinyViT strong boundary seed count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_positive_vs_magnitude"], 6, "TinyViT strong boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v3_mean_delta_vs_magnitude"], 0.03135, "TinyViT strong boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_gap_to_best"], 0.0027500000000000007, "TinyViT strong boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_positive_vs_magnitude"], 6, "TinyViT V4 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))

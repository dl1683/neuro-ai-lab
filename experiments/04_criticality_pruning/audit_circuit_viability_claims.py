...
def checks():
    ...
    out.append(close(tinyvit_boundary["seed_count"], 7, "TinyViT strong boundary seed count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_positive_vs_magnitude"], 5, "TinyViT strong boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_matches_best"], 5, "TinyViT strong boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_delta_vs_magnitude"], 0.03498571428571429, "TinyViT strong boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_gap_to_best"], 0.0007000000000000022, "TinyViT strong boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_positive_vs_magnitude"], 5, "TinyViT V4 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v4_mean_delta_vs_magnitude"], 0.035685714285714286, "TinyViT V4 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_gap_to_best"], 0.0, "TinyViT V4 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))

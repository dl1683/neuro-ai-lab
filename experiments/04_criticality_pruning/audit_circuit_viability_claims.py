...
def checks():
    ...
    out.append(close(tinyvit_boundary["seed_count"], 14, "TinyViT strong boundary seed count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_positive_vs_magnitude"], 8, "TinyViT strong boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_matches_best"], 8, "TinyViT strong boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_delta_vs_magnitude"], 0.024307142857142857, "TinyViT strong boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_gap_to_best"], 0.008435714285714288, "TinyViT strong boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_positive_vs_magnitude"], 8, "TinyViT V4 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_matches_best"], 10, "TinyViT V4 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_delta_vs_magnitude"], 0.024657142857142857, "TinyViT V4 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_gap_to_best"], 0.008085714285714286, "TinyViT V4 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_positive_vs_magnitude"], 9, "TinyViT V5 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_matches_best"], 12, "TinyViT V5 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_mean_delta_vs_magnitude"], 0.03252142857142857, "TinyViT V5 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_mean_gap_to_best"], 0.00022142857142857183, "TinyViT V5 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_positive_vs_magnitude"], 10, "TinyViT V6 boundary positive count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_matches_best"], 13, "TinyViT V6 boundary best-match count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_mean_delta_vs_magnitude"], 0.03268571428571428, "TinyViT V6 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_mean_gap_to_best"], 5.7142857142857785e-05, "TinyViT V6 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))

...
def checks():
    ...
    out.append(close(tinyvit_boundary["seed_count"], 13, "TinyViT strong boundary seed count", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v3_mean_delta_vs_magnitude"], 0.026238461538461537, "TinyViT strong boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v3_mean_gap_to_best"], 0.009023076923076924, "TinyViT strong boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v4_mean_delta_vs_magnitude"], 0.026615384615384614, "TinyViT V4 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v4_mean_gap_to_best"], 0.008646153846153847, "TinyViT V4 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v5_mean_delta_vs_magnitude"], 0.03508461538461539, "TinyViT V5 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v5_mean_gap_to_best"], 0.00017692307692307666, "TinyViT V5 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))
    ...
    out.append(close(tinyvit_boundary["v6_mean_delta_vs_magnitude"], 0.03526153846153846, "TinyViT V6 boundary mean delta", "tiny_vit_strong_selector_boundary_synthesis.json"))
    out.append(close(tinyvit_boundary["v6_mean_gap_to_best"], 0.0, "TinyViT V6 boundary mean oracle gap", "tiny_vit_strong_selector_boundary_synthesis.json"))

...
def write_report(result):
    out = ROOT / "results" / "04_criticality_pruning" / "cifar10_full_resnet20_tradeoff_selector_99pct_sgd20.json"
    out.write_text(json.dumps(result, indent=2) + "\n", encoding="utf-8")
    md = ROOT / "experiments" / "04_criticality_pruning" / "CIFAR10_FULL_RESNET20_TRADEOFF_SELECTOR_99PCT_SGD20.md"
    lines = [
...
def run():
    ...
    decisions = []
    for seed in SEEDS:
        print(f"seed {seed}: train dense full CIFAR-10 tradeoff-selector", flush=True)
        ...
        tradeoff = choose_tradeoff_viability_method(candidate_masks=candidate_masks, route_quality_fn=c10.r20.route_quality)
    ...
    result = {
        "experiment": "04_cifar10_full_resnet20_tradeoff_selector_99pct_sgd20",
        "setup": "Fresh full-CIFAR ResNet-20 99% sparsity test of a feature-preservation / liveness tradeoff selector.",
        "device": base.DEVICE,

...
def run():
    cases = [
        ...
        attach_wins(extract_case("cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong.json", None, "feature_route_margin_policy", "tinyvit feature-route margin selector v5 strong 90", "dead_outputs_mean"), "cifar10_tiny_vit_feature_route_margin_selector_v5_90pct_strong.json", "feature_route_margin_policy", 0.90),
